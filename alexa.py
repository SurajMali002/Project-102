...
def wishMe():
    ...
    speak("I am your virtual assistant, you can call me alexa.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak('My name is alexa and I an designed by SurajMali002')
        
        elif 'you live' in query:
            speak("I was built in India, Rajasthan, by a best developer called SurajMali")
